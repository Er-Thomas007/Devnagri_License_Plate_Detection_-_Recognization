...
def main():
    ...
    def display_detected_characters(detected_characters):
        if detected_characters:
            # Sort characters by y-coordinate and then by x-coordinate
    ...
    if media_type == 'Image':
        ...
        if image_file_buffer is not None:
            ...
            if st.button('Process Image', key='process_image'):
                ...
                for result in results:
                    ...
                    for box in filtered_boxes:
                        try:
                            ...
                            # Store character boxes and their positions
                ...
                # Sort detected characters by their x-coordinate to maintain the license plate order
